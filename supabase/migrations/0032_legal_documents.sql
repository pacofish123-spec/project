-- yoRento: Privacy Policy and Terms of Service, stored in the
-- database (not hardcoded into a page) so they can be updated without
-- a code deploy, and rendered from here on /privacy and /terms, with
-- links to both in the site-wide footer.
--
-- The text below is a real, substantive starting point written for
-- this specific marketplace (two-sided DR vehicle rental, Stripe/
-- PayPal payments, ID verification, condition reports) — not
-- boilerplate filler. It is NOT a substitute for review by a
-- Dominican Republic-licensed attorney before this is relied on as
-- your actual, binding legal terms. Placeholders like [Legal Entity
-- Name] and [Registered Address] need your real business details
-- filled in.
...
insert into public.legal_documents (slug, title, version, sections) values (
  'terms-of-service',
  'Terms of Service',
  1,
  $json$[
    {"heading": "1. Agreement to Terms", "body": [
      "These Terms of Service (\"Terms\") govern your access to and use of yoRento, a vehicle rental marketplace operated by [Legal Entity Name], a company organized under the laws of the Dominican Republic with its registered address at [Registered Address] (\"yoRento\", \"we\", \"us\", or \"our\").",
    ...
    {"heading": "10. Intellectual Property", "body": [
      "The yoRento name, logo, and platform design are the property of [Legal Entity Name]. You retain ownership of content you upload (such as vehicle photos), but grant yoRento a license to display it on the platform for the purpose of operating the marketplace."
    ]},
...
insert into public.legal_documents (slug, title, version, sections) values (
  ...
  $json$[
    {"heading": "1. Introduction", "body": [
      "This Privacy Policy explains what personal information yoRento (\"we\", \"us\", \"our\") collects through the yoRento platform, why we collect it, how it's used and shared, and the choices you have. It applies to anyone who creates an account, lists a vehicle, or books a vehicle through yoRento."
    ]},
    ...
    {"heading": "4. How We Share Information", "body": [
      ...
      "In a business transfer: if yoRento is involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction.",
