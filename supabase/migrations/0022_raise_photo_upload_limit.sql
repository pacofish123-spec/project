...
-- the project-wide Storage limit happens to be) to an explicit 50MB on
...
-- condition-report photo uploaders were raised to match this same 50MB
...
update storage.buckets set file_size_limit = 50000000 where id = 'vehicle-photos';
update storage.buckets set file_size_limit = 50000000 where id = 'condition-reports';
